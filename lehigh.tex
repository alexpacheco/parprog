...
%    \begin{tikzpicture}
%        \begin{axis}
%            \addplot [raw gnuplot] gnuplot [id=x]
%                {
%                set key top left;
...
%                set xlabel "N_{procs}";
%                set ylabel "Speedup";
%                plot f(x) title '', S(x,0.5) title 'f=0.5', S(x,0.1) title 'f=0.1', S(x,0.01) title 'f=0.01', S(x,0.001) title 'f=0.001';
%                };
%        \end{axis}
%    \end{tikzpicture}
\end{frame}
...
\end{align*}
%\item $P_{2,2}=M_{2,1}*N_{1,2}+M_{2,2}*N_{2,2}+M_{2,3}*N_{3,2}+M_{2,4}*N_{4,2}$
\begin{center}
