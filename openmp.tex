  ...
  \begin{columns}
    ...
    \begin{block}{Loops}
      \centering{
        ...
        \includegraphics[width=0.5\textwidth]{./work_share1}
      }
    \end{block}
    \column{0.33\textwidth}
    \begin{block}{Sections}
      \centering{
        ...
        \includegraphics[width=0.5\textwidth]{./work_share2}
      }
    \end{block}
    \column{0.33\textwidth}
    \begin{block}{Single}
      \centering{
        ...
        \includegraphics[width=0.5\textwidth]{./work_share3}
      }
    \end{block}
  \end{columns}
...
\begin{frame}[fragile]
  ...
  \begin{columns}
    \column{0.45\textwidth}
    \begin{exampleblock}{C/C++}
      \lstinputlisting[basicstyle=\footnotesize\ttfamily,language=OmpC,firstline=10,lastline=21]{./src/tmp.c}
    \end{exampleblock}
    \column{0.45\textwidth}
    \begin{exampleblock}{Fortran}
      \lstinputlisting[basicstyle=\footnotesize\ttfamily,language=OmpFortran,firstline=14,lastline=23]{./src/tmp.f90}
    \end{exampleblock}
  \end{columns}
\end{frame}
...
%    \column{0.45\textwidth}
%    \begin{block}{C}
%      \lstinputlisting[basicstyle=\fontsize{3.5}{4}\selectfont\ttfamily,language=OmpC]{src/saxpy/solution/saxpy.c}
%    \end{block}
%    \column{0.45\textwidth}
%    \begin{block}{Fortran}
%      \lstinputlisting[basicstyle=\fontsize{3.5}{4}\selectfont\ttfamily,language=OmpFortran]{src/saxpy/solution/saxpy.f90}
%    \end{block}
%  \end{columns}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \begin{columns}
    ...
    \column{0.45\textwidth}
    \begin{exampleblock}{}
      \lstinputlisting[basicstyle=\footnotesize\ttfamily,language=OmpFortran,firstline=51,lastline=57]{./src/tmp.f90}
    \end{exampleblock}
  \end{columns}
\end{frame}
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \vspace{-0.5cm}
    \begin{exampleblock}{}
      \lstinputlisting[basicstyle=\footnotesize\ttfamily,language=OmpFortran,firstline=59,lastline=65]{./src/tmp.f90}
    \end{exampleblock}
  \end{columns}
\end{frame}
...
%  \end{itemize}
  \begin{columns}
    ...
    \begin{exampleblock}{Critical}
      ...
      \lstinputlisting[basicstyle=\footnotesize\ttfamily,language=OmpFortran,firstline=67,lastline=73]{./src/tmp.f90}
    \end{exampleblock}
%  \end{columns}
%  \begin{itemize}
...
%  \begin{columns}
    ...
    \begin{exampleblock}{Atomic}
      ...
      \lstinputlisting[basicstyle=\footnotesize\ttfamily,language=OmpFortran,firstline=75,lastline=81]{./src/tmp.f90}
    \end{exampleblock}  
  \end{columns}
\end{frame}
