...
[alp514.sol](1032): gcc -fopenmp -o helloc hello.c
...
srun -p hawkgpu -n 6 -t 30 -A hpc2022_prog_083122 --reservation=hpc2022_prog_083122_183 --pty /bin/bash
...
./helloc
     ...
     \item Run from the head node: 
       \begin{lstlisting}[basicstyle=\footnotesize\ttfamily]
export OMP_NUM_THREADS=6
srun -p hawkgpu -n 6 -t 30 -A hpc2022_prog_083122 --reservation=hpc2022_prog_083122_183 ./helloc
       \end{lstlisting}
     \item Alternate way to run from the head node: 
       \begin{lstlisting}[basicstyle=\footnotesize\ttfamily]
srun -p hawkgpu -n 1 -c 6 -t 30 -A hpc2022_prog_083122 --reservation=hpc2022_prog_083122_183 --export=OMP_NUM_THREADS=6  ./helloc
       \end{lstlisting}
  \end{itemize}
%  \begin{columns}
%    \column{0.45\textwidth}
