...
\begin{frame}
  \frametitle{Advantages of OpenMP}
  \begin{block}{}
    \begin{itemize}
      \item Portability
      \begin{itemize}
...
\begin{frame}{Parallel Directive}
  ...
  \begin{columns}
    ...
    \begin{exampleblock}{C}
      \lstinputlisting[language=OmpC]{src/hello/solution/helloworld.c}
    \end{exampleblock}
    \column{0.45\textwidth}
    \begin{exampleblock}{Fortran}
      \lstinputlisting[language={OmpFortran}]{src/hello/solution/helloworld.f90}
    \end{exampleblock}
  \end{columns}
\end{frame}
\scriptsize
  ...
  \begin{columns}
    ...
    \begin{block}{}
       \begin{tabular}{lc}
        ...
        \\
        \quad print '(a,i3,a,i3,a)', 'Hello from thread',{\color{red}omp\_get\_thread\_num()} \tikz[na] \node[coordinate] (n3) {}; , \& & \\
...
\begin{frame}[fragile]
  ...
  \begin{columns}
    \column{0.45\textwidth}
    \begin{block}{C}
      \lstinputlisting[language=OmpC]{src/hello/exercise/hello.c}
    \end{block}
    \column{0.45\textwidth}
    \begin{block}{Fortran}
      \lstinputlisting[language=OmpFortran]{src/hello/exercise/hello.f90}
    \end{block}
  \end{columns}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \begin{columns}
    ...
    \begin{exampleblock}{C/C++}
      \lstinputlisting[language=OmpC]{src/hello/solution/hello.c}
    \end{exampleblock}
    \begin{block}{}
...
Hello world from thread 2, I am even
    ...
    \column{0.45\textwidth}
    \begin{exampleblock}{Fortran}
      \lstinputlisting[language={OmpFortran}]{src/hello/solution/hello.f90}
    \end{exampleblock}
    \begin{block}{}
      {\fontsize{4}{5}\selectfont
        \begin{Verbatim}
[alp514.sol](1906): pgfortran -mp  -o hellof hello.f90
...
\begin{frame}[fragile]
  ...
  \begin{columns}
    \column{0.45\textwidth}
    \begin{exampleblock}{C/C++}
      \lstinputlisting[language=OmpC,firstline=10,lastline=21]{./src/tmp.c}
    \end{exampleblock}
    \column{0.45\textwidth}
    \begin{exampleblock}{Fortran}
      \lstinputlisting[language=OmpFortran,firstline=14,lastline=23]{./src/tmp.f90}
    \end{exampleblock}
  \end{columns}
\end{frame}
...
\begin{frame}{Exercise: SAXPY}
  ...
  \begin{columns}
    \column{0.45\textwidth}
    \begin{block}{C}
      \lstinputlisting[basicstyle=\fontsize{3.5}{4}\selectfont\ttfamily,language=OmpC]{src/saxpy/exercise/saxpy.c}
    \end{block}
    \column{0.45\textwidth}
    \begin{block}{Fortran}
      \lstinputlisting[basicstyle=\fontsize{3.5}{4}\selectfont\ttfamily,language=OmpFortran]{src/saxpy/exercise/saxpy.f90}
    \end{block}
  \end{columns}
\end{frame}

\begin{frame}{Solution: SAXPY}
  \begin{columns}
    \column{0.45\textwidth}
    \begin{exampleblock}{C}
      \lstinputlisting[basicstyle=\fontsize{3.5}{4}\ttfamily,language=OmpC]{src/saxpy/solution/saxpy_omp.c}
    \end{exampleblock}
    \column{0.45\textwidth}
    \begin{exampleblock}{Fortran}
      \lstinputlisting[basicstyle=\fontsize{3.5}{4}\selectfont\ttfamily,language=OmpFortran]{src/saxpy/solution/saxpy_omp.f90}
    \end{exampleblock}
  \end{columns}
  \begin{columns}
    \column{0.8\textwidth}
    {
      \begin{exampleblock}{}
        \begin{tabular}{|b|b|b|b|}
          \hline
          \rowcolor{lublue}Language & Serial & OpenMP (10 Threads) & SpeedUp \\
          \hline
          C & 0.050000 & 0.011806 & 4.235 \\ \hline
...
\begin{frame}[allowframebreaks]{Exercise: Matrix Multiplication}
  \begin{itemize}
  ...
  \begin{columns}
    \column{0.45\textwidth}
    \begin{block}{C}
      \lstinputlisting[basicstyle=\fontsize{3.5}{3.5}\selectfont\ttfamily,language=OmpC]{src/matmul/exercise/matmul.c}
    \end{block}
    \column{0.45\textwidth}
    \begin{block}{Fortran}
      \lstinputlisting[basicstyle=\fontsize{3.5}{3.5}\selectfont\ttfamily,language=OmpFortran]{src/matmul/exercise/matmul.f90}
    \end{block}
  \end{columns}
\end{frame}

\begin{frame}{Solution: MATMUL}
  \begin{columns}
    \column{0.45\textwidth}
    \begin{exampleblock}{C}
      \lstinputlisting[basicstyle=\fontsize{3.5}{3.5}\selectfont\ttfamily,language=OmpC]{src/matmul/solution/matmul_omp.c}
    \end{exampleblock}
    \column{0.45\textwidth}
    \begin{exampleblock}{Fortran}
      \lstinputlisting[basicstyle=\fontsize{3.5}{3.5}\selectfont\ttfamily,language=OmpFortran]{src/matmul/solution/matmul_omp.f90}
    \end{exampleblock}
  \end{columns}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \begin{columns}
    \column{0.6\textwidth}
    \begin{center}
      \includegraphics[width=0.5\textwidth]{./falsesharing}
      \begin{exampleblock}{}
        \lstinputlisting[language=OmpFortran,firstline=51,lastline=57]{./src/tmp.f90}
      \end{exampleblock}
    \end{center}
  \end{columns}
\end{frame}
...
\begin{frame}
  ...
  \begin{columns}
    \column{0.5\textwidth}
    \begin{exampleblock}{}
      \lstinputlisting[language=OmpFortran,firstline=59,lastline=65]{./src/tmp.f90}
    \end{exampleblock}
  \end{columns}
\end{frame}
...
\begin{frame}
  ...
  \begin{columns}
    \column{0.5\textwidth}
    \begin{exampleblock}{}
      \lstinputlisting[language=OmpFortran,firstline=67,lastline=73]{./src/tmp.f90}
    \end{exampleblock}
  \end{columns}
  \begin{itemize}
  ...
  \begin{columns}
    \column{0.5\textwidth}
    \begin{exampleblock}{}
      \lstinputlisting[language=OmpFortran,firstline=75,lastline=81]{./src/tmp.f90}
    \end{exampleblock}  
  \end{columns}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \begin{columns}
    \column{0.45\textwidth}
    \begin{exampleblock}{C/C++}
      \lstinputlisting[basicstyle=\fontsize{5}{6}\selectfont\ttfamily,language=C]{./src/calc_pi/exercise/pi_serial.c}
    \end{exampleblock}
    \column{0.45\textwidth}
    \begin{exampleblock}{Fortran}
      \lstinputlisting[basicstyle=\fontsize{5}{6}\selectfont\ttfamily,language={[90]Fortran}]{./src/calc_pi/exercise/pi_serial.f90}
    \end{exampleblock}
  \end{columns}
\end{frame}
...
\begin{frame}[fragile,allowframebreaks]
  ...
  \begin{columns}
    \column{0.45\textwidth}
    \begin{exampleblock}{C/C++}
      \lstinputlisting[basicstyle=\fontsize{5}{6}\selectfont\ttfamily,language=OmpC]{./src/calc_pi/solution/pi_omp1.c}
    \end{exampleblock}
    \column{0.45\textwidth}
    \begin{exampleblock}{Fortran}
      \lstinputlisting[basicstyle=\fontsize{5}{6}\ttfamily,language=OmpFortran]{./src/calc_pi/solution/pi_omp1.f90}
    \end{exampleblock}
  \end{columns}
  \begin{block}{}
    {\tiny
...
\begin{frame}[fragile,allowframebreaks]
  ...
  \begin{columns}
    \column{5cm}
    \begin{exampleblock}{C }
      \lstinputlisting[basicstyle=\fontsize{5}{6}\selectfont\ttfamily,language=OmpC]{./src/calc_pi/solution/pi_omp.c}
    \end{exampleblock}
    \column{5cm}
    \begin{exampleblock}{Fortran}
      \lstinputlisting[basicstyle=\fontsize{5}{6}\ttfamily,language=OmpFortran]{./src/calc_pi/solution/pi_omp.f90}
    \end{exampleblock}
  \end{columns}
  \begin{block}{}
    {\tiny
