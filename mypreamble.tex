...
\newcommand{\lstfortran}[1]{\lstinline[language={[90]Fortran},basicstyle=\scriptsize\ttfamily]|#1|}
\newcommand{\lstC}[1]{\lstinline[language=C,basicstyle=\scriptsize\ttfamily]|#1|}
...
\setbeamercolor{subitem}{fg=lubrown}
\setbeamercolor{itemize/enumerate subbody}{fg=black!50!gray}
